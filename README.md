...
- [Каждый JavaScript Разработчик Должен Знать](https://github.com/gumennii/33-js-concepts)
- [Does it mutate](https://doesitmutate.xyz/)
- [Функциональное программирование на JS](https://github.com/hemanth/functional-programming-jargon#functional-programming-jargon)
- [Руководство по стилю JavaScript для Airbnb](https://airbnb.io/javascript/)
